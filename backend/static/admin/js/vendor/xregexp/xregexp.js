...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode selectedCategory. Addon packages for other Unicode
...
/* Adds data for the Unicode `Letter` selectedCategory. Addon packages include other categories, scripts,
